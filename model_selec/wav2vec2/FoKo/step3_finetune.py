...
dataset = load_from_disk('foreign_korean_preprocessed')
...
training_args = TrainingArguments(
    output_dir="./wav2vec2-foreign-korean",
    ...
    # sharded_ddp="simple",  # or "zero_dp_1"
...
# 파인튜닝 모델 저장
model.save_pretrained("wav2vec2-foreign-korean")
processor.save_pretrained("wav2vec2-foreign-korean")
